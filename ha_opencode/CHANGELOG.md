...
- **MCP 2025-11-25 alignment** — updated the MCP TypeScript SDK target to the current `1.29.x` line, added server implementation description metadata, and tightened no-argument tool schemas with `additionalProperties: false` per current MCP guidance.
